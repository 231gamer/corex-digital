      ...
      <div className="container-custom relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href={primaryHref} className="btn-primary bg-white text-accent hover:bg-gray-100">
              {primaryLabel}
            </Link>
            {secondaryHref && secondaryLabel && (
              <Link href={secondaryHref} className="btn-outline border-white text-white hover:bg-white hover:text-primary">
                {secondaryLabel}
              </Link>
            )}
          </div>
